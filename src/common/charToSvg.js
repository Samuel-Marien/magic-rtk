...
export const charToSvg = (char) => {
  const arrayOfString = char && char.match(/{[^}]+}/g)
  // console.log(arrayOfString)
  const arrayOfSvg =
    arrayOfString &&
    arrayOfString.map((item) => {
      const svg = charToSvgArray.find((itemSvg) => itemSvg.symbol === item)
      return svg ? svg.svg_uri : item
    })
  // console.log(arrayOfSvg)
  return arrayOfSvg
}
